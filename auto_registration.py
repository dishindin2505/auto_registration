...
wallet = "test"
hotkeys = ["testhot"] #a list with the names of all the hotkeys you want to register
highest_cost = 0.8 #The maximal amount of Tao you are willing to burn to register
password = "89325338508" #Password for your cold key
...
while True:
    for hotkey in hotkeys:
        while True:
            try:
                iterate=False
                command = 'btcli s register -subtensor.network finney --netuid 23 --wallet.name {} --wallet.hotkey {}'.format(wallet,hotkey)
